...
<div class="welcome">
      <div class="head">
        ...
        <div class="welcomebody">
         ...
         <div class="welcomehead"><h1>Welcome to my website</h1></div>
         ...
         <div class="welcomebutton"><button class="button"><i class="fas fa-download"></i><a class="isDisabled" href="NavyaRSogi.pdf" download="Resume.pdf">  DOWNLOAD RESUME</button></div>
...
<div class="contact">
 ...
 <div class="contactme">
  <h2><a  onclick="contactus()">CONTACT ME</h2>
...
<div id="loginfrm" >
      <div class="loginmodal" id="login" >
          ...
          <form name="loginform" class="lform" action="http://localhost:8080/Proj2_sogi_navya/server/login.php" method="post" onsubmit="return closelogindlg()"  >
 ...
 <div id="signupfrm" >
      <div class="loginmodal" id="signup">
          ...
          <form name="signupform" class="lform" action="http://localhost:8080/Proj2_sogi_navya/server/createuser.php" method="post" onsubmit="return closesignupdlg()" target="formSubmitFrame" >
              ...
              <div id="message">
                <h3 style="margin-left: 2px;">Password must contain the following:</h3>
